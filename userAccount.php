...
if(isset($_POST['signupSubmit'])){
    ...
    if(!empty($_POST['first_name']) && !empty($_POST['last_name']) && !empty($_POST['regno']) && !empty($_POST['email']) && !empty($_POST['age']) && !empty($_POST['gender'])  && !empty($_POST['username']) && !empty($_POST['residence']) && !empty($_POST['password']) && !empty($_POST['confirm_password'])  && !empty($_POST['phone'])){
